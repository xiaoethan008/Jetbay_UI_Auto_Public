...
| 资产 | 路径 |
| --- | --- |
| 版本执行记录 | `artifacts/官网V4.1.0（SOS）/测试执行记录_20260624_135557.md` |
| 需求覆盖矩阵 | `artifacts/官网V4.1.0（SOS）/需求覆盖矩阵_20260624_执行结果.md` |
| 问题清单 | `artifacts/官网V4.1.0（SOS）/问题清单` |
| 回归候选来源 | `artifacts/官网V4.1.0（SOS）/回归测试用例候选_20260626.md` |
